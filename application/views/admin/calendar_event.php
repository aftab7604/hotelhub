	...
	<div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Events Calendar Page</li>
            </ol>
        </div>
    </div>
    <?php
		...
		$arrOfTimeMap = array("12:00 AM", "12:30 AM", "01:00 AM", "01:30 AM", "02:00 AM", "02:30 AM", "03:00 AM", "03:30 AM", "04:00 AM", "04:30 AM", "05:00 AM", "05:30 AM", "06:00 AM", "06:30 AM", "07:00 AM", "07:30 AM", "08:00 AM", "08:30 AM", "09:00 AM", "09:30 AM", "10:00 AM", "10:30 AM", "11:00 AM", "11:30 AM", "12:00 PM", "12:30 PM", "01:00 PM", "01:30 PM", "02:00 PM", "02:30 PM", "03:00 PM", "03:30 PM", "04:00 PM", "04:30 PM", "05:00 PM", "05:30 PM", "06:00 PM", "06:30 PM", "07:00 PM", "07:30 PM", "08:00 PM", "08:30 PM", "09:00 PM", "09:30 PM", "10:00 PM", "10:30 PM", "11:00 PM", "11:30 PM");
		$eventToSelect = array();
		if(is_array($events)){
			foreach($events as $eventIndex => $eventArr)
			{
			if($eventArr->all_day=="1")
			{
				$startIndex = "0";
				$eventToSelect[$startIndex]["till"] = "47";
			}
			else
			{
				$startIndex = array_search($eventArr->start_time, $arrOfTimeMap);
				$endIndex	= array_search($eventArr->end_time, $arrOfTimeMap);
				$i =0;
				//$eventToSelect[$startIndex]["title"] = $eventArr->title;
				for($startIndex; $startIndex < $endIndex; $startIndex++){
					if($i==0){$eventToSelect[$startIndex]["title"] = $eventArr->title;}else{
						$eventToSelect[$startIndex]["title"] = '';
					}$i++;
				}
			}
			...
			//echo "<pre>";
			//unset($eventToSelect[0]);
			//print_r($eventToSelect);
		}
    ?>
    <div class="row">
        <div class="col-md-9">
        ...
        <div class="col-md-3 p-l-0 p-r-0" style="height:800px; overflow-y:scroll;" id="scrollMe">
            <div class="white-box">
            	<div class="row">
                	<div class="col-md-6"><h3 class="box-title">Schedule</h3></div>
                	<div class="col-md-6"><button type="button" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#add-new-event" class="btn btn-md btn-danger btn-block waves-effect waves-light"><i class="ti-plus"></i> Event</button></div>
                </div>
                <?php
				$period = "a";
				$id		= 0;
				...
				{
					$hourToShow = $hour;
					if($hour == 12){$period = "p"; $hourToShow = $hour;}
					if($hour >= 13){$period = "p"; $hourToShow = $hour-12;}
					
					$currentClassFirst = $currentClassSecond = $currentTitle= "";
					
					//echo "current ID =".$id." :::: NEW COUNTER = ".$till."<br/>";
					
					//if(isset($eventToSelect[$id]) /*|| $id == $till*/)
//					{
//						/*if(isset($eventToSelect[$id]))// || (isset($eventToSelect[$start]) && $eventToSelect[$id]["till"]<$eventToSelect[$start]["till"]))
//						{
//							$start	= $id;
//							$till	= $start+1;//$eventToSelect[$id]['till'];
//						}*/
//						$till = $eventToSelect[$id]["till"];
//						if($till < $id){
//							$currentClass = "current_time";
//							$till = $id+1;
//						}else{
//							$currentClass = "";
//							$till = '';
...
//					}
//					
					if(isset($eventToSelect[$id])){
						$currentClassFirst	= "selected";
						$currentClassSecond = "selected";
						$currentTitle = $eventToSelect[$id]["title"];
					}
					elseif($id == 18){$currentClassFirst = "current_time"; $currentClassSecond = "";}
				?>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-md-2 border_top">
                                <label class="control-label"><?php
                                if($hourToShow==0)
								{echo "12a";}
								else
								{echo $hourToShow.$period;}
								?></label>
                            </div>
                            <div class="col-md-10 border_left">
								...
								{echo $hourToShow.$period;}
								?>">
                            		<div <?php #if($hourToShow==9){echo "id='current_time_scroll'";}?> class="<?php echo $currentClassFirst." ".$id;$id++;?> first-thirty col-md-12 border_line p-l-0"><p class="text_cl"><?php echo $currentTitle;?></p></div>
                            		<div class="<?php echo $currentClassSecond." ".$id;$id++;?> second-thirty col-md-12 p-l-0"><p class="text_cl"></p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            ...
                            <div class="col-md-10 border_left">
								...
								{echo $hour.$period;}
								?>">
                            		<div class="first-thirty <?php echo $id;$id++;?> col-md-12 border_line p-l-0"><p class="text_cl"></p></div>
                            		<div class="second-thirty <?php echo $id;$id++;?> col-md-12 p-l-0"><p class="text_cl"></p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!--<div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-md-2 border_top">
                                <label class="control-label">1a</label>
                            </div>
                            <div class="col-md-10 border_left">
                                <div class="row">
                            		<div class="col-md-12 border_line p-l-0 selected"><p class="text_cl">Meeting with Brandon</p></div>
                            		<div class="col-md-12 p-l-0 selected"><p class="text_cl"></p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-md-2 border_top">
                                <label class="control-label">2a</label>
                            </div>
                            <div class="col-md-10 border_left">
                                <div class="row">
                            		<div class="col-md-12 border_line p-l-0 selected"><p class="text_cl"></p></div>
                            		<div class="col-md-12 p-l-0"><p class="text_cl"></p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-md-2 border_top">
                                <label class="control-label">3a</label>
                            </div>
                            <div class="col-md-10 border_left">
                                <div class="row">
                            		<div class="col-md-12 border_line p-l-0"><p class="text_cl"></p></div>
                            		<div class="col-md-12 p-l-0"><p class="text_cl"></p></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-md-2 border_top">
                                <label class="control-label">4a</label>
                            </div>
                            <div class="col-md-10 border_left">
                                <div class="row">
                            		<div class="col-md-12 border_line p-l-0 current_time"><p class="text_cl"></p></div>
                            		<div class="col-md-12 p-l-0"><p class="text_cl"></p></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-md-2 border_top">
                                <label class="control-label">5a</label>
                            </div>
                            <div class="col-md-10 border_left">
                                <div class="row">
                            		<div class="col-md-12 border_line p-l-0"><p class="text_cl"></p></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger delete-event waves-effect waves-light" data-dismiss="modal" onclick="delete_event();">Delete</button>
                </div>
            </div>
        </div>
    </div>
    <!-- Modal Add Category -->
    <div class="modal fade none-border" id="add-new-category">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    ...
    <div class="modal fade bs-pending-ticket" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;z-index:99999999999999999; top:100px;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade none-border" id="add-new-event" style="top:-32px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-b-0">
                    <form action="<?php echo base_url();?>event/save_event_info" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group m-b-5 has-errorr">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 p-l-0" style="display:none;" id="user_drp">
                                <div class="form-group m-b-5">
                            ...
                            <div class="col-md-3 p-l-0" style="display:none;" id="dept_drp">
                                <div class="form-group m-b-5">
                ...
                <div class="modal-footer p-t-0">
                    <button type="submit" class="btn btn-success waves-effect waves-light save-category"><i class="fa fa-check"></i> Save</button>
                    <button type="button" class="btn btn-white waves-effect" data-dismiss="modal">Close</button>
                    </form>
                </div>
            </div>

<div class="container-fluid">
	<div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Picked Tickets</h4> </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url();?>">Dashboard</a></li>
                <li class="active">Picked Tickets Page</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
        	<div class="panel panel-info">
                <div class="panel-heading">Picked Tickets</div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                    	<?php if(is_array($PickedTickets)){
											foreach($PickedTickets as $ind => $val){												
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal form-material" action="<?php echo base_url();?>ticket/ticket_closed" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control notes" id="notes_<?php echo $ticket_id;?>" name="notes" rows="5" cols="60"></textarea>
                                                                </div>
                                                                <div class="form-group">
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <?php if($ticket_type_id == 1){?>
                                                                		<button type="button" class="btn btn-danger waves-effect waves-light">PICKED-UP</button>
                                                                    <?php }else{if($val->service_rec == 'yes'){?>
                                                                    	<button type="button" class="btn btn-danger waves-effect waves-light"><blink style="color:#FFF;">PICKED-UP</blink></button>
                                                                    <?php }else{?>
                                                                		<button type="button" class="btn btn-danger waves-effect waves-light">PICKED-UP</button>
                                                                    <?php }}?>
                                                                </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
        														<div class="col-md-6"><b>Time Elasped:</b> <span class="get_started_<?php echo $ticket_id;?>"><?php echo "<script> showElapsdTimeElapsed('".$estimatedTime."', '".$ticket_id."');</script>";?></span></div>
        														<div class="col-md-6"><b>Time Remaining:</b> <span class="pickup_started_<?php echo $ticket_id;?>"><?php echo "<script> showPickedupTime('".$estimatedTime."', '".$ticket_id."');</script>";?></span></div>
                                                            </div>
                                                            <hr />
                                                            <?php
															if($ticket_type_id == 1){?>
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<?php if($val->ticket_filename !='' || $val->pickup_filename !=''){?>
                                                            ...
                                                            <div class="row" id="quickReplyDiv_<?php echo $ticket_id;?>" style="display:none;">
                                                                <div class="col-md-12">
                                                                	<form action="" id="quickMessageForm_<?php echo $ticket_id;?>" method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <input type="hidden" id="qmajax_<?php echo $ticket_id;?>" name="notes" value="" />                                                                        <div class="row send-chat-box">
                                                            ...
                                                            <!--<div class="row" id="replydiv_<?php echo $ticket_id;?>" style="display:none;">
                                                                <div class="col-md-12">
                                                                	<form action="" id="messageForm_<?php echo $ticket_id;?>" method="post" enctype="multipart/form-data">
                                                                        <div class="form-group">
                                                                        	<input type="hidden" name="ticket_num" value="<?php echo $ticket_id;?>" />
                                                                            <textarea class="form-control notes" id="edit_notes_<?php echo $ticket_id;?>" name="notes" rows="5" cols="60"></textarea>
                                                                        </div>
                                                                        <div class="form-group">
                                                            ...
                                                            <div class="row" id="action_bar_<?php echo $ticket_id;?>">
                                                                ...
                                                                <div class="col-md-4 text-center"><button type="button" class="btn btn-danger waves-effect waves-light" data-toggle="modal" data-target="#TID_Model_<?php echo $ticket_id;?>">Close Ticket</button></div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <ul class="pager m-0">
                                                                ...
                                                                <?php }else{?>
                                                                    <li class="previous"><a href="javascript:;" data-dismiss="modal" onclick="popToLoadID('.bs-pending-ticket-<?php echo $PickedTickets[$ind-1]->ticketID;?>');">&larr; Previous</a></li>
                                                                <?php }if($ind==(count($PickedTickets)-1)){?>
                                                                    <li class="next disabled"><a href="javascript:;">Next &rarr;</a></li>
                                                                <?php }else{?>
                                                                    <li class="next"><a href="javascript:;" data-dismiss="modal" onclick="popToLoadID('.bs-pending-ticket-<?php echo $PickedTickets[$ind+1]->ticketID;?>');">Next &rarr;</a></li>
                                                                <?php }?>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $picked_by;?></td>
                                                <td><?php echo date("m-d-y", strtotime($val->pickup_date));?></td>
                                                <td><?php echo date("h:i a", strtotime($val->pickup_date));?></td>
                                                <td class="get_started_<?php echo $ticket_id;?>"><?php echo "<script>showElapsdTimeElapsed('".$val->created_date."', '".$ticket_id."');</script>";?></td>
                                                <td class="pickup_gap_<?php echo $ticket_id;?>"><?php echo "<script> showElapsdTimeGap('".$val->pickup_date."', '".$ticket_id."');</script>";?></td>
                                                <td class="pickup_started_<?php echo $ticket_id;?>"><?php echo "<script> showPickedupTime('".$estimatedTime."', '".$ticket_id."');</script>";?></td>
                                                <td>
                                                	<button type="button" onclick="loadpopupModal(<?php echo $ticket_id;?>)" data-toggle="modal" data-target=".bs-pending-ticket-<?php echo $ticket_id;?>" class="btn btn-warning waves-effect waves-light model_img img-responsive">View</button>
                                                	<button type="button" class="btn btn-danger waves-effect waves-light" data-toggle="modal" data-target="#TID_Model_<?php echo $ticket_id;?>">Close Ticket</button></td>
                                            </tr>
                                            <script>

...
!function($) {
    ...
    CalendarApp.prototype.onEventClick =  function (calEvent, jsEvent, view) {
        var $this = this;
		$('.modal-title').text('Event Information');
		var form = $("<form></form>");
		form.append("<label>" + calEvent.title +"</label>");
		form.append("<div class='input-group'>" + calEvent.description +"</div><br>");
		form.append("<input class='form-control' type=hidden id=event_id name=event_id value='" + calEvent.id + "' />");
		//form.append("<div class='input-group'><input class='form-control' type=text value='" + calEvent.title + "' /><span class='input-group-btn'><button type='submit' class='btn btn-success waves-effect waves-light'><i class='fa fa-check'></i> Save</button></span></div>");
		
		//form.append("<div class='input-group'><a target='_blank' href='https://www.hotelgss.com/pmp/checklist/"+calEvent.room_no_only+"/"+calEvent.room_type+"/"+calEvent.quarter_only+"'>View More Details</a></div>");
    ...
    CalendarApp.prototype.init = function() {
        ...
        $this.$calendarObj = $this.$calendar.fullCalendar({
            ...
            events: 'https://hotelhub.io/event/get_all_events/',
            editable: true,
